...
export const software = [
  {
    ...
    filePath: 'https://drive.google.com/file/d/1RSiRuT0PU1-yvwjQGCw9AvvlMxYYAA_z/view?usp=sharing', // Path to the file in the /public folder
...

  {
    ...
    filePath: 'https://drive.google.com/file/d/1JEuKZzdTxYsFMBl2W8K1HkmxGy0Pdxxx/view?usp=sharing', // Path to the file in the /public folder
    passwordKey: 'COOL_APP_PASSWORD', // The key for the password in .env.local
  },
